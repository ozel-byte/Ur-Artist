...
class EditTextFieldEmailHuerfano extends StatefulWidget {
  final String? email;
   const EditTextFieldEmailHuerfano({super.key,this.email});

  @override
  State<EditTextFieldEmailHuerfano> createState() => _InputEditState();
}

class _InputEditState extends State<EditTextFieldEmailHuerfano> {
