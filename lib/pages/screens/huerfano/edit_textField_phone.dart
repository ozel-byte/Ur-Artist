...
class EditTextFieldPhoneHuerfano extends StatefulWidget {
  final String? phone;
   const EditTextFieldPhoneHuerfano({super.key,this.phone});

  @override
  State<EditTextFieldPhoneHuerfano> createState() => _InputEditState();
}

class _InputEditState extends State<EditTextFieldPhoneHuerfano> {
  ...
  void initState() {
    ...
    super.initState();
      _textEditingController.text = widget.phone!;
