...
class EditTextFieldBioHuerfano extends StatefulWidget {
  final String? bio;
   const EditTextFieldBioHuerfano({super.key,this.bio});

  @override
  State<EditTextFieldBioHuerfano> createState() => _InputEditState();
}

class _InputEditState extends State<EditTextFieldBioHuerfano> {
  ...
  void initState() {
    ...
    super.initState();
      _textEditingController.text = widget.bio!;
