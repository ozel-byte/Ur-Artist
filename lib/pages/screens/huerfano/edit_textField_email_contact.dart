...
class EditTextFieldEmailCotactHuerfano extends StatefulWidget {
  final String? email;
   const EditTextFieldEmailCotactHuerfano({super.key,this.email});

  @override
  State<EditTextFieldEmailCotactHuerfano> createState() => _InputEditState();
}

class _InputEditState extends State<EditTextFieldEmailCotactHuerfano> {
  ...
  void initState() {
    ...
    super.initState();
      _textEditingController.text = widget.email!;
