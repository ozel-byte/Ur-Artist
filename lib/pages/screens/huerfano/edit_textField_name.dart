...
class EditTextFieldNameHuerfano extends StatefulWidget {
  final String? nombre;
   const EditTextFieldNameHuerfano({super.key,this.nombre});

  @override
  State<EditTextFieldNameHuerfano> createState() => _InputEditState();
}

class _InputEditState extends State<EditTextFieldNameHuerfano> {
  ...
  void initState() {
    ...
    super.initState();
      _textEditingController.text = widget.nombre!;
